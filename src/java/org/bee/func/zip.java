...
public class zip {
	 ...
	 * 
	 * @param delPats
	 *            1 - zip archive name 2.. files to be zipped
	...
	public static boolean eval(Object... args) {
		...
		try {
			...
			// System.out.printf("Zipping to %s args : %d%n", zipFile,
			// args.length);
	...
	private static void zipFiles(File folder, String[] selection, String current, ZipOutputStream zs) throws IOException {
		// System.out.printf("Processing: %s, %s / %s%n", folder,
		// Arrays.toString(selection), current);
