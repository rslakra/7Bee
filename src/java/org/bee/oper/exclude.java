...
public class exclude {
	public static InfoHolder<String, String, List<Object>> proceed(InfoHolder<String, String, List<Object>> op1, InfoHolder<String, String, Object> op2) {
		return doOperator(op1, op2);
	}
	
	public static InfoHolder<String, String, List<Object>> doOperator(InfoHolder<String, String, List<Object>> op1, InfoHolder<String, String, Object> op2) {
